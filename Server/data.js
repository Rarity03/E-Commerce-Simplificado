const Products = [
    ...
    {
      name: " Amaze1 85 Inch WebOS 4KUHD LED TV (AZ85WOUSFL)",
      image:
    ...
    {
      name: " Onida 124.46 cm (50 Inches) 4K UHD LED Smart TV 50UIB (Black)",
      image:
    ...
    {
      name: " Daktron 85 Inch 4K Ultra HD Smart Android LED TV",
      image:
    ...
    {
      name: " Jbl Professional Eon612 1000W Bluetooth, Wireless Speaker - Black",
      image:
    ...
    {
      name: "DualSense Edge Wireless Controller (PlayStation 5)",
      image:
    ...
    },
    {
      ...
      price: 648,
      description:
        "Introducing Xbox series X, the fastest, most powerful Xbox ever. Play thousands of names from four generations of consoles—all games look and play best on Xbox series X\r\nExperience next-gen speed and performance with the Xbox velocity architecture, powered by a custom SSD and integrated software",
        stock: 14,
        state: 'available',
      category: "gaming",
      discount: 19,
    ...
    {
      name: "Hyperkin MegaRetroN HD Gaming Console for Genesis/ Mega Drive",
      image:
    ...
    {
      name: "Anchor by Panasonic GrestarÂ Personal Fan (Grey, 225 mm)",
      image:
    ...
    {
      name: "Havells Koolaire-W 51L 220W Desert Cooler, Ghracaaw050",
      image:
    ...
    {
      name: "Sujata Powermatic Plus 900 Watts Juicer Mixer Grinder",
      image:
    ...
    {
      name: "Eveready 9W b22d LED Inverter Bulb (White)",
      image:
    ...
    {
      name: "Crompton Ginie Neo Personal Air Cooler - 10L, White and Light Blue",
      image:
